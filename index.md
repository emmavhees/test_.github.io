...
**Technical**: Python, Google Cloud Platform (Pub/Sub, VertexAI, Cloud run, Cloud functions, Bigquery, Cloud Storage), Docker, Airflow, Git, Scrum, Pytorch, SQL, PowerBI, FastAPI
